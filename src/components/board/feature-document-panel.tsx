        ...
        {!doc && !docContent?.content && !isLoading ? (
          ...
          <>
            ...
            {isLoading ? (
              ...
              <div data-feature-doc-error className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-6 text-center">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium text-text-primary">Couldn’t load this document</p>
                  <p className="mx-auto max-w-sm text-xs text-text-muted">
                    {fetchError instanceof Error && fetchError.message ? fetchError.message : "Something went wrong fetching the content. It may be a temporary network issue."}
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    data-doc-retry-btn={documentType}
                    onClick={handleReload}
                    className="flex items-center gap-1.5 rounded-md border border-border bg-surface px-3 py-1.5 text-xs font-medium text-text-primary transition-colors hover:bg-surface-secondary"
                  >
                  ...
                  {githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer noopener"
                      className="flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium text-text-secondary transition-colors hover:bg-surface hover:text-text-primary"
                    >
                      Open in GitHub
                      <ExternalLink className="h-3.5 w-3.5" aria-hidden="true" />
                    </a>
