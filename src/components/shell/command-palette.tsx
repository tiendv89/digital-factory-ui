...
import { ArrowRight, Bot, LayoutGrid, MessageSquare, Search, Settings, Users, Zap } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex w-full max-w-lg flex-col overflow-hidden rounded-[13px] border border-border bg-surface shadow-[0_8px_20px_rgba(0,0,0,0.5)]"
