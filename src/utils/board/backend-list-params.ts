import type { PaginationMeta } from "@/components/board/types";
...
export function buildBoardFeatureParams(params: BoardListParams): FeatureSearchParams {
  return {
    title: params.title,
...
export function buildBoardTaskParams(params: BoardListParams): TaskSearchParams {
  return {
    title: params.title,
    status: params.status,
    page: params.page,
 ...
 */
export function shouldResetPage(prev: BoardListParams, next: BoardListParams): boolean {
  return (
