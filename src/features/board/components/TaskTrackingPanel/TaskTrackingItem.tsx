...
export function TaskTrackingItem({
  ...
  const lastUpdatedLabel = useRelativeTime(task.execution?.last_updated_at);
      ...
      <div className="flex min-w-0 flex-wrap items-center gap-1.5 text-[10px] leading-4 text-text-secondary">
        ...
        {lastUpdatedLabel && (
          <span
            ...
            className="border border-primary-light bg-primary-light px-1.5 font-mono font-semibold text-primary"
          >
            {lastUpdatedLabel}
          </span>
        )}
